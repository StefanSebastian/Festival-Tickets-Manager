...
set CLASSPATH=%APP_HOME%\lib\Server-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Model-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Repository-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Services-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Networking-1.0-SNAPSHOT.jar;%APP_HOME%\lib\mysql-connector-java-5.1.6.jar
